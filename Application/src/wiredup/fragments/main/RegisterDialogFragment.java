...
public class RegisterDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		this.editTextFirstName = (EditText) rootView
				.findViewById(R.id.editText_firstName);
		this.editTextLastName = (EditText) rootView
				.findViewById(R.id.editText_lastName);
	...
	public void onResume() {
		...
		positiveButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				String firstName = RegisterDialogFragment.this.editTextFirstName
						.getText().toString();
				String lastName = RegisterDialogFragment.this.editTextLastName
						.getText().toString();
				String email = RegisterDialogFragment.this.editTextEmail
						.getText().toString();
				String password = RegisterDialogFragment.this.editTextPassword
						.getText().toString();
				String confirmPassword = RegisterDialogFragment.this.editTextConfirmPassword
						.getText().toString();
				...
				if (!RegisterDialogFragment.this.arePasswordsEqual(password,
						confirmPassword)) {
					errorMessageBuilder.append("'Passwords' don't match\n");
				}

				if (errorMessageBuilder.length() != 0) {
					Toast.makeText(RegisterDialogFragment.this.getActivity(),
							errorMessageBuilder.toString(), Toast.LENGTH_LONG)
							.show();
				} else {
